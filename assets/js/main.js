...
function toggleSkills(el) {
  el.parentNode.className === "skills__content skills__close"
    ? (el.parentNode.className = "skills__content skills__open")
    : (el.parentNode.className = "skills__content skills__close");
}

[...skillsHeader].forEach((el) => {
  el.addEventListener("click", () => toggleSkills(el));
});
